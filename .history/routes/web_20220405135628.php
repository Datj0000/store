...
Route::group(['middleware' => 'mod'], function(){
    ...
    //ImportDetail
    Route::get('/fetchdata-detail/{id}',[ImportDetailController::class,'fetchdata']);
    Route::post('/create-detail',[ImportDetailController::class,'create']);
    Route::get('/edit-detail/{id}',[ImportDetailController::class, 'edit']);
    Route::post('/update-detail/{id}',[ImportDetailController::class,'update']);
    Route::get('/destroy-detail/{id}',[ImportDetailController::class,'destroy']);
