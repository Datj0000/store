...
//Order
Route::get('/view-order',[CustomerController::class,'index']);
Route::get('/fetchdata-order',[CustomerController::class,'fetchdata']);
Route::post('/create-order',[CustomerController::class,'create']);
Route::get('/edit-order/{id}',[CustomerController::class, 'edit']);
Route::post('/update-order/{id}',[CustomerController::class,'update']);
Route::get('/destroy-order/{id}',[CustomerController::class,'destroy']);
