...
//OrderDetail
Route::get('/fetchdata-importdetail/{id}',[OrderDetailController::class,'fetchdata']);
Route::post('/create-importdetail/{id}',[OrderDetailController::class,'create']);
Route::get('/edit-importdetail/{id}',[OrderDetailController::class, 'edit']);
Route::post('/update-importdetail/{id}',[OrderDetailController::class,'update']);
Route::get('/destroy-importdetail/{id}',[OrderDetailController::class,'destroy']);
