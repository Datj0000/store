        ...
        $(document).on('click', '.edit_importdetail', function(e) {
            ...
            axios({
                ...
                .then(function (response) {
                    ...
                    $('#edit_importdetail_import_price').val();
                    $('#edit_importdetail_sell_price').val();
                    $('#edit_importdetail_date_start').val();
                    $('#edit_importdetail_date_end').val();
                    $('#edit_importdetail_quantity').val();
                    $('#edit_importdetail_drive').val();
                    $('#edit_importdetail_vat').val();
