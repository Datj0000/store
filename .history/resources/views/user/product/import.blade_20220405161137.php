    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit_importdetail', function(e) {
            ...
            axios({
                ...
                .then(function (response) {
                    $('#edit_import_id').val(response.data.id);
                    $('#importdetail_image').get(0).files[0];
                    $('#product_id').val(response.data);
                    $('#edit_importdetail_import_price').val(response.data);
                    $('#edit_importdetail_sell_price').val(response.data);
                    $('#edit_importdetail_date_start').val(response.data);
                    $('#edit_importdetail_date_end').val(response.data);
                    $('#edit_importdetail_quantity').val(response.data);
                    $('#edit_importdetail_drive').val(response.data);
                    $('#edit_importdetail_vat').val(response.data);
