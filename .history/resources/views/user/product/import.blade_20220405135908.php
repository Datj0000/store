    ...
    <div class="modal fade" id="exampleModalSizeSm3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form_add_detail">
                        <div class=" card-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="image-input image-input-outline image-input" id="kt_image_1">
                                        ...
                                        <label
                                            ...
                                            <input id="detail_image" type="file" name="image" accept=".png, .jpg, .jpeg" />
                            ...
                            <div class="form-group">
                                ...
                                <input name="iprice" type="number" class="form-control form-control-solid" min="0"
                                       id="detail_import_price" placeholder="Giá nhập" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==20) return false;"/>
                            </div>
                            <div class="form-group">
                                <label>Giá bán:</label>
                                <input name="sprice" type="number" class="form-control form-control-solid" min="0"
                                       id="detail_sell_price" placeholder="Giá bán" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==20) return false;"/>
                            </div>
                            <div class="form-group">
                                <label>Số lượng:</label>
                                <input name="quantity" type="number" class="form-control form-control-solid" min="0"
                                       id="detail_quantity" placeholder="Số lượng" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==20) return false;"/>
                            </div>
                            <div class="form-group">
                                <label>Link drive:</label>
                                <input name="drive" type="text" class="form-control form-control-solid"
                                       id="detail_drive" placeholder="Link drive" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                            ...
                            <div class="form-group">
                                ...
                                <input name="vat" type="text" class="form-control form-control-solid"
                                       id="detail_vat" placeholder="Thuế" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                            ...
                            <div class="form-group">
                                <div class="input-daterange input-group" id="kt_datepicker_5">
                                    ...
                                    <input style="border-radius: 7px; margin: 0 10px" autocomplete="off" id="detail_date_start" type="text"
                                           class="form-control" name="start" />
                                    <label class="col-form-label text-right">Đến</label>
                                    <input style="border-radius: 7px; margin: 0 0 0 10px" autocomplete="off" id="detail_date_end" type="text"
                                           class="form-control" name="end" />
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button id="create_detail" type="button" class="btn btn-primary mr-2">Thêm mới</button>
                            <button type="reset" class="btn btn-secondary">Nhập lại</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form_edit_import">
                        ...
                        <div class="card-footer">
                            <button id="update_detail" type="button" class="btn btn-primary mr-2">Cập nhật</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var form3 = KTUtil.getById('form_add_detail');
        ...
        var form4 = KTUtil.getById('form_edit_detail');
        ...
        $(document).on('click', '#create_detail', function(e) {
            e.preventDefault();
            var detail_image = $('#detail_image').get(0).files[0];
            var product_id = $('#product_id').val();
            var detail_import_price = $('#detail_import_price').val();
            var detail_sell_price = $('#detail_sell_price').val();
            var detail_date_start = $('#detail_date_start').val();
            var detail_date_end = $('#detail_date_end').val();
            var detail_quantity = $('#detail_quantity').val();
            var detail_drive = $('#detail_drive').val();
            var detail_vat = $('#detail_vat').val();
            var form_data = new FormData();
            validation.validate().then(function(status) {
                if (status == 'Valid') {
                    form_data.append("detail_image", detail_image);
                    form_data.append("product_id", product_id);
                    form_data.append("detail_import_price", category_id);
        ...
        $(document).on('click', '.destroy_detail', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            Swal.fire({
                title: "Xoá nhập hàng",
