<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        ...
        <div class="card-toolbar">
            <span class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#exampleModalSizeSm3">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#create_import', function(e) {
            e.preventDefault();
            // $('#exampleModalSizeSm').hide();
            $('#exampleModalSizeSm3').addClass("show");
            $('#exampleModalSizeSm3').attr("role","dialog");
