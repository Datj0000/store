        ...
        var table = $('#kt_datatable').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `\
                            <span onclick="load_detail(${row.id})" data-toggle="modal" data-target="#exampleModalSizeSm3" data-id='' class="add_detail btn btn-sm btn-clean btn-icon" title="Nhập hàng">\
