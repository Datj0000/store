...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#create_importdetail', function(e) {
            ...
            var importdetail_image = $('#importdetail_image').get(0).files[0];
            var product_id = $('#product_id').val();
            var importdetail_import_price = $('#importdetail_import_price').val();
            var importdetail_sell_price = $('#importdetail_sell_price').val();
            var importdetail_date_start = $('#importdetail_date_start').val();
            var importdetail_date_end = $('#importdetail_date_end').val();
            var importdetail_quantity = $('#importdetail_quantity').val();
            var importdetail_drive = $('#importdetail_drive').val();
            var importdetail_vat = $('#importdetail_vat').val();
            var form_data = new FormData();
            validation.validate().then(function(status) {
                if (status == 'Valid') {
                    form_data.append("importdetail_image", importdetail_image);
                    form_data.append("product_id", product_id);
                    form_data.append("importdetail_import_price", importdetail_import_price);
                    form_data.append("importdetail_sell_price", importdetail_sell_price);
                    form_data.append("importdetail_date_start", importdetail_date_start);
                    form_data.append("importdetail_date_end", importdetail_date_end);
                    form_data.append("importdetail_quantity", importdetail_quantity);
                    form_data.append("importdetail_drive", importdetail_drive);
                    form_data.append("importdetail_vat", importdetail_vat);
                    axios({
