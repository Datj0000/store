                    ...
                    <form class="form" id="form_create_order">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="feeship" type="number" class="form-control form-control-solid" id="order_fee_ship" placeholder="Phí lắp đặt" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                            </div>
                            @if(Auth::user()->role <= 1)
                                <div class="form-group">
