                        ...
                        <div class="card-body">
                            ...
                            @if(Auth::user()->role <= 1)
                                <div class="form-group">
                                    ...
                                    <input name="code" type="text" class="form-control form-control-solid" id="order_code" placeholder="Địa chỉ" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                                </div>
                            @endif
                        </div>
