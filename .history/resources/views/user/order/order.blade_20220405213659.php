<style>
    ...
    .li_search_coupon li:active,
    .li_search_coupon li:hover {
        color: #717fe0;
    }
</style>
                        ...
                        <div class="card-body">
                            ...
                            @if(Auth::user()->role <= 1)
                                <div class="form-group">
                                    ...
                                    <input name="coupon" type="text" class="form-control form-control-solid" id="order_coupon" autocomplete="off" placeholder="Mã giảm giá" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;" style="position: relative"/>
