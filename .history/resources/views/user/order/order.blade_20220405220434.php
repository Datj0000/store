                    ...
                    <form class="form" id="form_create_order">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input list="cars" name="customer" type="text" class="form-control form-control-solid" id="customer_id" placeholder="Họ và tên" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                                <datalist id="cars">
                                    <option>Volvo</option>
                                    <option>Saab</option>
