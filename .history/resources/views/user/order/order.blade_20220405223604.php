                    ...
                    <form class="form" id="form_create_order">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input style="position: relative" name="customer" type="text" class="form-control form-control-solid" id="customer_name" placeholder="Họ và tên" autocomplete="off" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
