                ...
                <div class="modal-body">
                    <form class="form" id="form_create_order">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Khách hàng:</label>
                                <input name="feeship" type="text" class="form-control form-control-solid" id="customer_id" placeholder="Họ và tên" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;"/>
                            </div>
                            @if(Auth::user()->role <= 1)
                                <div class="form-group">
