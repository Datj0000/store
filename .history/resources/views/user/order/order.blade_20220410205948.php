                            ...
                            @if(Auth::user()->role <= 1)
                                <div class="form-group">
                                    ...
                                    @php
                                        ...
                                        if($coupon){
                                            echo '<input value="'.$coupon.'" name="coupon" type="text" class="form-control form-control-solid" id="order_coupon" autocomplete="off" placeholder="Tìm kiếm theo mã giảm giá" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;" />'
                                        } else {
                                            echo '<input name="coupon" type="text" class="form-control form-control-solid" id="order_coupon" autocomplete="off" placeholder="Tìm kiếm theo mã giảm giá" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==255) return false;" />'
                                        }
                                    @endphp
