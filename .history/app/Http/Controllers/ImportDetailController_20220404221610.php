            ...
            if ($data_count > 0) {
                ...
                foreach ($data as $key => $item) {
                    ...
                    $output .= '
                        <tr>
                            <td>' . $i . '</td>
                            <td style="with: 15%"><input id="edit_episode_name_'.$item->id.'" class="custom_input" value="'.$item->episode_name.'" type="text"></td>
                            <td style="with: 45%"><input id="edit_episode_link_'.$item->id.'" class="custom_input" value="'.$item->episode_link.'" type="text"></td>
                            <td style="with: 15%">';
