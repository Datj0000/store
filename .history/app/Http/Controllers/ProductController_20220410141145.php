...
class ProductController extends Controller
{
    ...
    {
        if (Auth::check()) {
            $detail = ImportDetail::query()->select('suppliers.name as supplier_name','suppliers.created_at as supplier_time','products.name','imports.supplier_id','importdetails.*')
