        ...
        if (Auth::check()) {
            ...
            if (Session::get('cart')) {
                foreach (Session::get('cart') as $key => $cart) {
                    $details = OrderDetail::query()->create([
                        'order_id' => $order->id,
                        'product_code' => $request->input('product_code'),
                        'method_pay' => $request->input('product_quantity'),
                    ]);
                    ...
                    $details->save();
                    $import = ImportDetail::query()->where('product_code',$details->input('product_code'))->first();
