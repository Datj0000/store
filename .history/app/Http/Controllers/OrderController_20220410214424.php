                ...
                <tr>
                    ...
                    <td>
                        <div class="wrap-num-product flex-w">
                            ...
                            <input min="1" max="' . $check_qty->quantity - $check_qty->soldout. '" data-type="'.$request->input('cart').'" data-session_id="' . $cart['session_id'] . '" class="cart_qty txt-center num-product" type="number" value="' . $cart['product_quantity'] . '">
