                ...
                <tr>
                    ...
                    <td>
                        <div class="wrap-num-product flex-w">
                            <div data-type="'.$request->input('cart').'" data-session_id="' . $cart['session_id'] . '" class="btn-num-product-down hov-btn3 flex-c-m">
                            ...
                            <div data-type="'.$request->input('cart').'" data-session_id="' . $cart['session_id'] . '" class="btn-num-product-up hov-btn3 flex-c-m">
