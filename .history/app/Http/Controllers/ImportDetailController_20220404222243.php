                ...
                foreach ($data as $key => $item) {
                    ...
                    $output .= '
                        <tr>
                            ...
                            $output .='
                            <td><input id="edit_detail_name_'.$item->id.'" class="custom_input" value="'.$item->product_name.'" type="text"></td>
                            <td><input id="edit_detail_link_'.$item->id.'" class="custom_input" value="'.$item->detail_drive.'" type="text"></td>
                            <td>';
