                ...
                foreach ($data as $key => $item) {
                    ...
                    $output .= '
                        <tr>
                            ...
                            $output .='</td>
                            <td>
                                <span data-id='.$item->id.' class="edit_episode btn btn-sm btn-clean btn-icon" title="Sửa">
                                    <i class="la la-edit"></i>
                                </span>
                                <span data-id='.$item->id.' class="delete_episode btn btn-sm btn-clean btn-icon" title="Xoá">
