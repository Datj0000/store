    ...
    public function create(Request $request, int $id):int
    {
        if (Auth::check()) {
            ...
            if (!$check){
                ...
                $detail->import_id = $request->$id;
                $detail->product_id = $request->product_id;
                $detail->detail_import_price = $request->detail_import_price;
                $detail->detail_sell_price = $request->detail_sell_price;
                $detail->detail_date_start = $request->detail_date_start;
                $detail->detail_date_end = $request->detail_date_end;
                ...
                Carbon::parse($request->coupon_date_start)->format('Y-m-d');
                if ($get_image) {
