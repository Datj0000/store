    ...
    public function fetchdata(int $id)
    {
        if (Auth::check()) {
            ...
            if ($detail_count > 0) {
                    ...
                    $output .= '
                        <tr>
                            ...
                            <td>
                                ...
                                <span data-toggle="modal" data-target="#exampleModalSizeSm2" data-id='.$item->id.' class="edit_importdetail btn btn-sm btn-clean btn-icon" title="Sửa">
                ...
                $output .= '<tr style="text-align: center" ><td colspan="11">Hoá đơn nhập hàng này chưa có sản phẩm</td></tr>';
            }
            return $output;
        }
    }
