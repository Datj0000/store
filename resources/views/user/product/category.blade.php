    ...
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-label">Danh sách danh mục
                <span class="d-block text-muted pt-2 font-size-sm">Quản lý danh sách danh mục</span>
            </h3>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form_add_category">
                        <div class=" card-body">
                        ...
                        <div class="card-footer">
                            <button id="create_category" type="button" class="btn btn-primary mr-2">Thêm mới</button>
    ...
    <div class="modal fade" id="exampleModalPopovers2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form_edit_category">
                        <div class=" card-body">
                        ...
                        <div class="card-footer">
                            <button id="update_category" type="button" class="btn btn-primary mr-2">Cập nhật</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="Text/javascript">
    $(document).ready(function() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `\
                            <span data-toggle="modal" data-target="#exampleModalPopovers2" data-id='${row.id}' class="edit_category btn btn-sm btn-clean btn-icon" title="Sửa">\
								<i class="la la-edit"></i>\
							</span>\
                            <span data-id='${row.id}' class="destroy_category btn btn-sm btn-clean btn-icon" title="Xoá">\
        ...
        var form = KTUtil.getById('form_add_category');
        ...
        var form2 = KTUtil.getById('form_edit_category');
